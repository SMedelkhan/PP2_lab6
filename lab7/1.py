...
rightarm = pygame.image.load("lab7/images/min_hand.png")
leftarm = pygame.image.load("lab7/images/sec_hand.png")
mainclock = pygame.transform.scale(pygame.image.load("lab7/images/clock.png"), (650, 500))
